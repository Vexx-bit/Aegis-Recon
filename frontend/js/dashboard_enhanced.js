    ...
    try {
        ...
        modalBody.innerHTML = `
            ...
            <div id="reportContent" class="report-printable">
                ...
                <!-- Footer - Will be at natural end of content -->
                <div class="report-footer">
                    <p style="margin: 0;">Generated by <strong style="color: #64748b;">Aegis Recon Security Platform</strong></p>
                    <p style="margin: 0.25rem 0 0 0; font-size: 0.65rem;">© ${new Date().getFullYear()} - Confidential Security Assessment</p>
                </div>
            </div>
        `;
